...
<footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="https://livwork.com.br">
                    LivWork
                  </a>
                </li>
                <li class="nav-item">
            ...
            <div class="copyright">
              ...
              <a href="#">Plataforma Um</a>
            </div>
            <div>
              Distributed by
              <a target="_blank" href="https://www.livwork.com.br/">LivWork</a>.
            </div>
          </div>
        </footer>
      </div>
...
<!-- Chart JS -->
<script src="{{ url('admin/js/plugin/chart.js/chart.min.js') }}"></script>
...
<!-- jQuery Vector Maps -->
<script src="{{ url('admin/js/plugin/jsvectormap/jsvectormap.min.js') }}"></script>
<script src="{{ url('admin/js/plugin/jsvectormap/world.js') }}"></script>
...
<script src="{{ url('admin/js/setting-demo.js') }}"></script>
