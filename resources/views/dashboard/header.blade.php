...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="https://static.wixstatic.com/media/51fd44_abd33239604841a6a9b7d5401e986be4~mv2.png/v1/fill/w_600,h_529,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/013.png"
      type="image/x-icon"
    />
...
<script>
  WebFont.load({
    ...
    custom: {
      ...
      urls: ["{{ url('admin/css/fonts.min.css') }}"],
    },
    active: function () {
                  ...
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="{{route('transacoes')}}">
                        <span class="sub-item">Transações</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route('form-transacao')}}">
                        <span class="sub-item">Realizar Transações</span>
                      </a>
                    </li>

                    <li>
                      <a href="{{route('form-usuario')}}">
                        <span class="sub-item">Cadastrar Usuários</span>
                      </a>
                    </li>
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                        ...
                        <div class="row m-0">
                          ...
                          <a class="col-6 col-md-4 p-0" href="#">
                            <div class="quick-actions-item">
                              ...
                              <span class="text">Nota Fiscal</span>
                            </div>
                          </a>
                          <a class="col-6 col-md-4 p-0" href="#">
                            <div class="quick-actions-item">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="https://img.freepik.com/vetores-premium/avatar-de-homem-foto-generica-de-perfil-masculino-na-web_53562-18550.jpg"
                        alt="..."
